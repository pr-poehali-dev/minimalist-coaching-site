...
const services = [
  ...
  },
  {
    ...
    details:
      'Возможные форматы: личное прохождение (решить свой запрос за одну игру), групповое (ответы приходят из общего поля через инсайты участников), корпоративное (объединение команды). Демо-версия доступна в Telegram: @IgraSilaBot — приблизьтесь к решению своего вопроса уже сейчас!',
