...
const services = [
  ...
  },
  {
    ...
    format: 'онлайн или офлайн в Москве',
    prices: [{ duration: '1 месяц', price: '70 000 ₽' }],
  },
  {
  ...
  {
    title: 'Трансформационная игра "Сила"',
    image: 'https://cdn.poehali.dev/files/e720c5fb-d0f5-4263-808e-0e00d39a14b7.jpg',
    description:
      'Хороший инструмент для раскрытия личной силы, преодоления ограничений и активации внутренних ресурсов. Помогает найти точку опоры, вернуть энергию, почувствовать уверенность, найти ответы.',
    details:
      'Возможные форматы: личное прохождение (решить свой запрос за одну игру), групповое (ответы приходят из общего поля через инсайты участников), корпоративное (объединение команды). Демо-версия доступна в Telegram: https://t.me/IgraSilaBot — приблизьтесь к решению своего вопроса уже сейчас!',
    format: 'офлайн в Москве или онлайн',
    prices: [{ duration: 'под запрос', price: 'договорная' }],
  },
];
